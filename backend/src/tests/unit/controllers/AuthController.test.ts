...
describe('AthController.createAccount', () => {

    beforeEach(() => {
        jest.resetAllMocks()
    })
    it('should return a 409 status and erro message if the email is already registered', async () => {
    ...
    it('Should register a new user and return a success message', async () => {
        ...
        (hashPassword as jest.Mock).mockResolvedValue('hashespassword');
        ...
        expect(mockUser.password).toBe('hashespassword')
